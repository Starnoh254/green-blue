...
const OPTVerify = (props) => {
  ...
  const sendOPT = async () => {
    ...
    const config = {
      headers: {
        // previous api key - bee5607eb45d7e20b5a8ce77193f08c4-b7f660d2-c25a-4eeb-abf0-4ff0e099626b
        
        Authorization: `App 2430147050248585cb026826a99ca06c-3afc35d9-b9ea-4150-b3cf-73624f18e999`,
      },
    };
    axios
    // past base url -  6jqv98
      .post(`https://dk282l.api.infobip.com/sms/2/text/advanced`, data, config)
      .then((res) => {
        setCount(99);
